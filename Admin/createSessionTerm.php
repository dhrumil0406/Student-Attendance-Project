...
{    
    ...
    if($result > 0)
    { 
        $statusMsg = "<div class='alert alert-danger' style='margin-right:450px;'>This Session and Term Already Exists!</div>";
    }
    else
    {
        ...
        if ($query)
        {
            $statusMsg = "<div class='alert alert-success'  style='margin-right:450px;'>Created Successfully!</div>";
        }
        else
        {
            $statusMsg = "<div class='alert alert-danger' style='margin-right:450px;'>An error Occurred!</div>";
        }
    }
}
                            ...
                            <div class="card mb-4">
                                ...
                                <form method="post">
                                    <div class="form-group row mb-3">
                                        <div class="col-xl-6">
                                            <label class="form-control-label">Acadamic Year (Runnin Year)<span class="text-danger ml-2">*</span></label>
                                            <input type="text" class="form-control" name="sessionName" value="<?php echo $row['sessionName'];?>" id="exampleInputFirstName" placeholder="Ex: 2021/2022">
                                        </div>
                                        <div class="col-xl-6">
                                            <label class="form-control-label">Term<span class="text-danger ml-2">*</span></label>
                                            <select required name="termId" class="form-control mb-3">
                                    ...
                                    <div class="card mb-4">
                                        ...
                                        <div class="table-responsive p-3">
                                            <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                                                ...
                                                <tbody>
                                                    <?php
                                                        $query = "SELECT * FROM `tblsessionterm`";
