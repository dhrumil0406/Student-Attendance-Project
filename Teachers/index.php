            ...
            <div id="content">
                ...
                <div class="container-fluid" id="container-wrapper">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Teacher's Dashboard For <b>(<?php echo $_SESSION['deptName'];?>)</b> Department</h1>
                        <ol class="breadcrumb">
                    ...
                    <div class="row mb-3">
                        ...
                        <?php 
                            $query = mysqli_query($conn,"SELECT * FROM `tblstudents` WHERE class LIKE '$_SESSION[deptName]%'");
                        ...
                        <?php 
                            $query = mysqli_query($conn,"SELECT dbname FROM `tbldbs` WHERE deptname = '$_SESSION[deptName]'");
                        ...
                        <?php 
                            ...
                            $query = mysqli_query($conn,"SELECT * from tblsession where class LIKE '$_SESSION[deptName]%'");
                            $totsession = mysqli_num_rows($query);
                        ?>
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card h-100">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $totsession;?></div>
                                            <div class="mt-2 mb-0 text-muted text-xs">
