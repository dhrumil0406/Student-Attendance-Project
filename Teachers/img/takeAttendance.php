                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form action="" method="post">
                                                    <label class="form-control-label">Enter Students Roll No...<span class="text-danger ml-2">*</span></label>
                                                    <textarea name="rnos" id="rnos" cols="30" rows="5" class="form-control" placeholder="Ex: 1 2 3 4 ..."></textarea>
