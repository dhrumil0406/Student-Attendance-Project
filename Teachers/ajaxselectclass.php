...
<?php
    ...
    {
        echo '<select required name="class" id="class" onchange="helo("class",this.value),changesubjects(this.value),changestudents(this.value,"<?php echo $dbname2;?>"),showclass(2,"<?php echo $dbname2; ?>",this.value,"<?php echo $subject; ?>")" class="form-control mb-3">
