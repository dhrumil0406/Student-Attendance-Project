...
<html lang="en">
    ...
    <head>
        ...
        <script>
            ...
            function showclass(str,str2,str3,str4)
            {
                if (str == "")
                {
                ...
                else
                {
                    ...
                    xmlhttp.open("GET","ajaxclassattendance.php?Idd="+ str +"&dbname2="+ str2 + "&class=" + str3 + "&subject=" + str4);
                    xmlhttp.send();
                }
            }
                                        ...
                                        <form method="post">
                                            <div class="form-group row mb-3">
                                                <div class="col-xl-6">
                                                    ...
                                                    <?php
                                                        ...
                                                        {
                                                            ?>
                                                                <select required name="dbname" id="dbchange" onchange="helo('dbname2',this.value),changeclass(this.value),showclass(1,this.value,'<?php echo $class; ?>','<?php echo $subject; ?>')" class="form-control mb-3">
                                                            <?php
                                                ...
                                                <div class="col-xl-6">
                                                    ...
                                                    <select required name="class" id="class" onchange="helo('class',this.value),changesubjects(this.value),showclass(2,'<?php echo $dbname2; ?>',this.value,'<?php echo $subject; ?>')" class="form-control mb-3">
                                            ...
                                            <div class="form-group row mb-3">
                                                <div class="col-xl-6">
                                                    ...
                                                    <select name="subjectName" id="subjects" onchange="helo('subject',this.value),showclass(3,'<?php echo $dbname2; ?>','<?php echo $class; ?>',this.value)" class="form-control mb-3">
