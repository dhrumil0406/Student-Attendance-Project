    ...
    <head>
        ...
        <script>
            function checkdata()
            {
                    ...
                    xmlhttp.open("GET","ajaxchangepass.php");
                    xmlhttp.send();
            }
            // function helo(){
            //     const searchparams = new URLSearchParams(window.location.search)
            //     searchparams.set('dbname2', $_GET['dbname2'])
                                            ...
                                            <div class="card-body">
                                                ...
                                                <form method="Post" action="">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" name="username" id="username" placeholder="Enter Admission Id" value="<?php echo $username; ?>">
                                                    </div>
                                                    <div class="form-group">
